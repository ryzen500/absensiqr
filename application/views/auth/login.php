...
<body style="background-image:url(<?php echo base_url() ?>assets/images/smkn.jpg);background-size:cover;" class="hold-transition login-page">
...
<div class="login-box">
  <div class="login-logo">
    <a href="#"><b>SMKN 2</b> <b>SURABAYA</b></a>
  </div>
  <!-- /.login-logo -->
